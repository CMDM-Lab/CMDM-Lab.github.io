...
EOF;
    ...
    function get_journal(){
		return array(
			array('Lin SW, Kang WY, Lin DT, Lee J CS, Lin Wu FL, Chen CL, Tseng YJ, Comparison of warfarin therapy clinical outcomes following implementation of an automated mobile phone-based critical laboratory value text alert system, BMC Medical Genomics 2014, 2014 May 8;7(Suppl 1):S13 [SCI]'),
			array('Tsai IL, Weng TI, Tseng YJ, Tan HK, Sun HJ, Kuo CH, Screening and Confirmation of 62 Drugs of Abuse and Metabolites in Urine by Ultra-High-Performance Liquid Chromatography-Quadrupole Time-of-Flight Mass Spectrometry, J Anal Toxicol., 2013 Nov-Dec;37(9):642-51 [SCI]'),
			array('Liu CT, Rajasekaran R, Lin SH, Wang SY, Kuo CH, Tseng YJ, Sheen LY, Metabolomics of Ginger Essential Oil against Alcoholic Fatty Liver in Mice, J Agric Food Chem., 2013 Nov 20;61(46):11231-40 [SCI]'),
			array('Su BH, Huang YS, Chang CY, Tu YS, Tseng YJ, Template-Based de Novo Design for Type II Kinase Inhibitors and Its Extented Application to Acetylcholinesterase Inhibitors, Molecules, 2013 Oct 31;18(11):13487-50 [SCI]'),
			array('Kuo TC, Tian TF, Tseng YJ, 3Omics: a web-based systems biology Tool for analysis, integration and visualization of human transcriptomic, proteomic and Metabolomic data, BMC Syst Biol., 2013 Jul 23;7:64 [SCI]'),
			...
			array('Huang CC, McDermott MM, Liu K, Kuo CH, Wang SY, Tao H, Tseng YJ, Plasma metabolomic profiles predict near-term death among individuals with lower extremity peripheral arterial disease, Journal of Vascular Surgery, 2013 Oct;58(4):989-96 [SCI]'),
			array('Tseng YJ, Martin E, Bologa C, Anang S, Cheminformatics Aspects of High Throughput Screening: from Robots to Models: Symposium Summary, J. Comput. Aided Mol. Des., 2013 May;27(5):443-53 [SCI]'),
			array('Chang CY, Hsu MT, Esposito EX, Tseng YJ, Oversampling to Overcome Overfitting: Exploring the relationship between data set composition, molecular descriptors, and predictive modeling methods, J. Chem. Inf. Model., 2013 Apr 22;53(4):958-71 [SCI]'),
			array('Tsai DM, Kang JJ, Lee SS, Wang SY, Tsai IL, Chen GY, Liao HW, Li WC, Kuo CH, Tseng YJ, Metabolomic Analysis of Complex Chinese Remedies: Examples of Induced Nephrotoxicity in the Mouse from a Series of Remedies Containing Aristolochic Acid, Evidence-Based Complementary and Alternative Medicine, 2013; 2013:263757 [SCI]'),
			array('Tseng YJ, Kuo CT, Wang SY, Liao HW, Chen GY, Ku YL, Shao WC, Kuo CH, Metabolomic characterization of rhubarb species by capillary electrophoresis and ultra-high-pressure liquid chromatography, Electrophoresis, 2013 Oct;34(19):2918-27 [SCI]'),
			array('Ho TJ, Kuo CH, Wang SY, Chen GY, Tseng YJ, True ion pick (TIPick): a denoising and peak picking algorithm to extract ion signals from liquid chromatography/mass spectrometry data, J. Mass Spectrom., 2013 Feb; 48(2):234–242 [SCI]'),
			array('Shao CY, Chen SZ, Su BH, Tseng YJ, Esposito EX, Hopfinger AJ, Dependence of QSAR Models on the Selection of Trial Descriptor Sets: A Demonstration Using Nanotoxicity Endpoints of Decorated Nanotubes, J. Chem. Inf. Model., 2013 Jan 28;53(1):142–158 [SCI]'),
			array('Wang KC, Wang SY, Kuo CH, Tseng YJ, Distribution-Based Classification Method for Baseline Correction of Metabolomic 1D Proton Nuclear Magnetic Resonance Spectra, Analytical Chemistry, 2013 Jan 15;85(2):1231–1239 [SCI]'),
			...
			array('Jansen JM, Amaro RE, Cornell W, Tseng YJ, Walters WP, Computational chemistry and drug discovery: a call to action, Future Med Chem., 2012 Oct;4(15):1893-6 [SCI]'),
			array('Jansen JM, Cornell W, Tseng YJ, Amaro RE, Teach-Discover-Treat (TDT): Collaborative computational drug discovery for neglected diseases, J Mol Graph Model., 2012 Sep;38:360-2 [SCI]'),
			array('Su BH, Tu YS, Esposito EX, Tseng YJ, Predictive toxicology modeling: protocols for exploring hERG classification and Tetrahymena pyriformis end point predictions, J. Chem. Inf. Model., 2012 Jun 25;52(6):1660-73 [SCI]'),
			array('Kuo CH, Wang KC, Tian TF, Tsai MH, Chiung YM, Hsiech CM, Tsai SJ, Wang SY, Tsai DM, Huang CC, Tseng YJ, Metabolomic characterization of laborers exposed to welding fumes, Chem Res Toxicol., 2012 Mar 19;25(3):676-86 [SCI]'),
			array('Tseng YJ, Hopfinger AJ, Esposito EX, The great descriptor melting pot: mixing descriptors for the common good of QSAR models, J. Comput. Aided Mol. Des., 2012 Jan; 26(1):39-43 [SCI]'),
			array('Lin FY, Tseng YJ, Structure-based Fragment Hopping for Lead Optimization Using Predocked Fragment Database, J. Chem. Inf. Model., 2011 Jul 25;51(7):1703-15 [SCI]'),
			array('Shen MY, Su BH, Esposito EX, Hopfinger AJ, Tseng YJ, A comprehensive support vector machine binary hERG classification model based on extensive but biased end point hERG data sets, Chem. Res. Toxicol., 2011 Jun 20;24(6):934-49 [SCI]'),
			array('Wang SY, Ho TJ, Kuo CH, Tseng YJ, Chromaligner: a web server for chromatogram alignment, Bioinformatics, 2010 Sep 15;26(18):2338-9 [SCI]'),
			array('Su BH, Shen MY, Esposito EX, Hopfinger AJ, Tseng YJ, In silico binary classification QSAR models based on 4D-fingerprints and MOE descriptors for prediction of hERG blockage, J. Chem. Inf. Model., 2010 Jul 26;50(7):1304-18 [SCI]'),
			array('Kuo CH, Lee CW, Lin SC, Tsai IL, Lee SS, Tseng YJ, Kang JJ, Peng FC, Li WC, Rapid determination of aristolochic acids I and II in herbal products and biological samples by ultra-high-pressure liquid chromatography-tandem mass spectrometry, Talanta, 2010 Mar 15;80(5):1672-80 [SCI]'),
 ...
 */
    ...
    function get_conference(){
		return array(
	    array('Wang SY, Kuo CH, and Tseng YJ, An ion trace detection algorithm to extract pure ion chromatogram to improve untargeted peak detection quality for LC/TOF-MS-based metabolomics data, 10th International conference of the Metabolomics Society, Tsuruoka, Japan, June 26-29, 2014'),
	    array('Tsai DM, Kuo CH, and Tseng YJ, Strategy of UPLC/MS-based Targeted Metabolomics, 10th International conference of the Metabolomics Society, Tsuruoka, Japan, June 26-29, 2014'),
	    array('Tan CE, Chung YY, and Tseng YJ, IDMass: GC/MS Data Management and Analyzes Software for Metabolomics Studies, 10th International conference of the Metabolomics Society, Tsuruoka, Japan, June 26-29, 2014'),
 ...
 */
    ...
    function get_members(){
		$allstudents = array(
			array(	'ch_name'	=> '蘇柏翰',
					'en_name'	=> 'B.H. SU',
					'email'		=> 'suborhang@gmail.com',
					'degree'	=> array('phd' => 2012),
					'abbr_name'	=> 'su bh'),
			array(	'ch_name'	=> '張嘉芸',
					'en_name'	=> 'CHIA-YUN CHANG',
					'email'		=> 'chiayun.chang@gmail.com',
					'topic'		=> array('Computer-aided drug design'),
					'degree'	=> array('phd' => 2013),
					'abbr_name'	=> 'chang cy'),
			array(	'ch_name'	=> '王國清',
					'en_name'	=> 'KUO-CHING WANG',
					'email'		=> 'm001030@ms.skh.org.tw',
					'topic'		=> array('metabolomic NMR spectrum baseline correction, alignment, deconvolution, and data management'),
					'award'		=> array('台大生醫電資所第三屆獎勵研究創新學生傑出研究獎'),
					'degree'	=> array('phd' => 2013),
					'abbr_name'	=> 'wang kc'),
			array(	'ch_name'	=> '王三源',
					'en_name'	=> 'SAN-YUAN WANG',
					'email'		=> 'sanyuan731@gmail.com',
					'degree'	=> array('phd' => 2014),
					'abbr_name'	=> 'wang sy'),
			array(	'ch_name'	=> '郭天爵',
					'en_name'	=> 'TIEN-CHUEH KUO',
					'email'		=> 'cotcage@gmail.com',
			...
			array(	'ch_name'	=> '杜羿樞',
					'en_name'	=> 'YI-SHU TU',
					'email'		=> 'georgetu@gmail.com',
					'award'		=> array('台大生醫電資所第二屆獎勵研究創新學生傑出研究獎'),
					'degree'	=> array('phd' => 6, 'master' => 2009),
					'abbr_name'	=> 'tu ys'),
			array(	'ch_name'	=> '蔡東銘',
					'en_name'	=> 'DONG-MING TSAI',
					'email'		=> 'dongming7829@gmail.com',
					'degree'	=> array('phd' => 5, 'master' => 2009),
					'abbr_name'	=> 'tsai dm'),
			array(	'ch_name'	=> '徐銘聰',
					'en_name'	=> 'M.T. HSU',
					'email'		=> 'trams10@gmail.com',
			...
			array(	'ch_name'	=> '林澤豪',
					'en_name'	=> 'Z.H. Lin',
					'email'		=> 'kobe761021@gmail.com',
					'degree'	=> array('master' => 2012, 'bachelor' => 2010),
					'abbr_name'	=> 'lin zh'),
			array(	'ch_name'	=> '陳星佐',
					'en_name'	=> 'S.Z. Chen',
					'email'		=> 'w7418574185@gmail.com',
					'degree'	=> array('master' => 2012),
					'abbr_name'	=> 'chen sz'),
			array(	'ch_name'	=> '林芳宇',
					'en_name'	=> 'F.Y. Lin',
					'email'		=> 'florafangyu@gmail.com',
					'award'		=> array('台大生醫電資所第一屆獎勵研究創新年度最佳碩士學位論文獎', '台大生醫電資所第一屆獎勵研究創新學生傑出研究獎'),
					'degree'	=> array('master' => 2011),
					'abbr_name'	=> 'lin fy'),
			array(	'ch_name'	=> '何宗融',
					'en_name'	=> 'T.J. Ho',
					'email'		=> 'pipisteve2@gmail.com',
					...
					'degree'	=> array('master' => 2011, 'bachelor' => 2009),
					'abbr_name'	=> 'ho tj'),
			array(	'ch_name'	=> '田士鋒',
					'en_name'	=> 'T.F. Tian',
					'email'		=> 'newtonstudio@gmail.com',
					'degree'	=> array('master' => 2011),
					'abbr_name'	=> 'tian tf'),
			array(	'ch_name'	=> '韓羽晨',
					'en_name'	=> 'Y.C. Harn',
					'email'		=> 'duke3d.harn@gmail.com',
					'award'		=> array('Best Informatics presentation award, 7th International Conference of the Metabolomics Society, Cairns, Australia'),
					'degree'	=> array('master' => 2011),
					'abbr_name'	=> 'harn yc'),
			array(	'ch_name'	=> '蔡政倢',
					'en_name'	=> 'C.C. Tsai',
					'email'		=> 'mustkevin@gmail.com',
					'degree'	=> array('master' => 2010),
					'abbr_name'	=> 'tsai cc'),
			array(	'ch_name'	=> '沈孟俞',
					'en_name'	=> 'M.Y. Shen',
					'email'		=> 'mengyu.shen@gmail.com',
					'degree'	=> array('master' => 2010, 'bachelor' => 2008),
					'abbr_name'	=> 'shen my'),
			array(	'ch_name'	=> '黃薏璇',
					'en_name'	=> 'Y.S. Huang',
					'email'		=> 'rabbita1101@gmail.com',
					'degree'	=> array('master' => 2010),
					'abbr_name'	=> 'huang ys'),
			array(	'ch_name'	=> '黃永沅',
					'en_name'	=> 'Y.Y. Huang',
			...
			array(	'ch_name'	=> '康文譯',
					'en_name'	=> 'W.Y. Kan',
					'email'		=> 'whph93@gmail.com',
					'degree'	=> array('master' => 2009),
					'abbr_name'	=> 'kan wy'),
			array(	'ch_name'	=> '吳東潤',
					'en_name'	=> 'D.M. Wu',
					'email'		=> 'chameleon1410@gmail.com',
					'degree'	=> array('master' => 2009),
					'abbr_name'	=> 'wu dm'),
			array(	'ch_name'	=> '江任捷',
					'en_name'	=> 'R.J. Jiang',
					'email'		=> 'djws978@yahoo.com.tw',
					'degree'	=> array('master' => 2008),
					'abbr_name'	=> 'jiang rj'),
			array(	'ch_name'	=> '杜宗霖',
					'en_name'	=> 'Z.L. TU',
					'email'		=> 'x955161@gmail.com',
					'degree'	=> array('master' => 4),
					'abbr_name'	=> 'tu zl'),
			array(	'ch_name'	=> '徐國翔',
					'en_name'	=> 'K.H. HSU',
					'email'		=> 'kfrankisflying@gmail.com',
					'degree'	=> array('master' => 3),
					'abbr_name'	=> 'hsu kh'),
			array(	'ch_name'	=> '邵祈諭',
					'en_name'	=> 'C.Y. SHAO',
					'email'		=> 'eddieshao89@gmail.com',
					'degree'	=> array('master' => 2013),
					'abbr_name'	=> 'shao cy'),
			array(	'ch_name'	=> '劉家瑋',
					'en_name'	=> 'J.W. LIU',
					'email'		=> 'mark.jwliu@gmail.com',
			...
			array(	'ch_name'	=> '鍾宇彥',
					'en_name'	=> 'Y.Y. ZHONG',
					'email'		=> 'wangedwardd@gmail.com',
					'degree'	=> array('master' => 2013),
					'abbr_name'	=> 'zhong yy'),
			array(	'ch_name'	=> '路本庭',
					'en_name'	=> 'BRENDAN REILLY',
					'email'		=> 'brendan.lbt@gmail.com',
			...
			array(	'ch_name'	=> '譚承恩',
					'en_name'	=> 'C.E. TAN',
					'email'		=> 'b96b02054@csie.ntu.edu.tw',
					'degree'	=> array('master' => 2),
					'abbr_name'	=> 'tan ce'),
			array(	'ch_name'	=> '林潔',
					'en_name'	=> 'J Lin',
					'award'		=> array(
						'Fellowship of GARMIN corporation – Excellent academic performance in department, 2014',
						'Presidential Award*7 of NTU – Excellent performance and ranked in top 7 in class, 2010, 2011, 2012, 2013',
						'Honorable Member of The Phi Tau Phi Scholastic Honor Society – Excellent academic performance in department, 2013',
						'Fellowship of NTU Alumni Association – Excellent academic performance in department, 2012',
						'Dean’s List Award *3 of NTU – Helping other students to improve their class performance and provide academic consultation to them, 2010, 2011',
						'Outstanding Award in Service Learning Education of NTU – Excellent peroformance of being a campus guide in service learning course, 2011'),
					'degree'	=> array('master' => 2, 'bachelor' => 2013),
					'abbr_name'	=> 'lin j'),
			array(	'ch_name'	=> '陳琤',
					'en_name'	=> 'Z. Chen',
					'degree'	=> array('bachelor' => 2013),
					'abbr_name'	=> 'chen z'),
			array(	'ch_name'	=> '陳奕竹',
					'en_name'	=> 'Y.Z. Chen',
					'degree'	=> array('bachelor' => 2013),
			...
			array(	'ch_name'	=> '劉昕',
					...
					'abbr_name'	=> 'liu h'),
			array(	'ch_name'	=> '陣一慧光',
					'degree'	=> array('bachelor' => 2009),
					'abbr_name'	=> 'unknown'),
			array(	'ch_name'	=> '余相甫',
					'en_name'	=> 'X.F. Yu',
					'degree'	=> array('bachelor' => 2008),
					'abbr_name'	=> 'yu xf'),
			array(	'ch_name'	=> '林峰生',
					'en_name'	=> 'F.S. Lin',
					'degree'	=> array('bachelor' => 2008),
			...
			array(	'ch_name'	=> '葉欣宜',
					'en_name'	=> 'X.Y. Yeh',
					'email'		=> 'cindyysi@gmail.com',
					'degree'	=> array('bachelor' => 2008),
					'abbr_name'	=> 'yeh xy'),
			array(	'ch_name'	=> '謝秉翰',
					'en_name'	=> 'P.H. Hsieh',
					'degree'	=> array('bachelor' => 4),
					'abbr_name'	=> 'hsieh ph')
		);

		$students = array(
			'phd students'		=> array(),
			'master students'	=> array(),
			'bachelor students'	=> array(),
			'alumni 2014'	=> array(),
			'alumni 2013'	=> array(),
			'alumni 2012'	=> array(),
			'alumni 2011'	=> array(),
		...
		foreach ($allstudents as $student) {
			...
			foreach ($student['degree'] as $degree => $year) {
				if ($year < 10) {	// means it's student
					$students["$degree students"][] = $student;
				} else {
					$students["alumni $year"][] = $student;
					break;
				}
			}
		}
