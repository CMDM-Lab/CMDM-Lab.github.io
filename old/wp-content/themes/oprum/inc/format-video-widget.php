 ...
 * @package Oprum
 */
add_action('widgets_init', create_function('', 'register_widget("Oprum_Post_Format_Video_Widget");'));

class Oprum_Post_Format_Video_Widget extends WP_Widget {
    function __construct() {
        parent::WP_Widget('post_format_video_widget', 'Post Format Video', array('description'=>__('Post Format Video', 'oprum') ));
    }
