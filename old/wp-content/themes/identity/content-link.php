		...
		<div class="inner-flex">
			...
			<div class="inner-right">
				<header class="entry-header">
					...
					<?php the_title( sprintf( '<h1 class="entry-title link-title"><a href="%s" target="_blank">', esc_url( identity_get_link_url() ) ), '<span class="genericon genericon-external"></span></a></h1>' ); ?>
